...
namespace Tests\Pamil\CartCommand\Application\CommandHandler;
...
use Pamil\CartCommand\Application\CommandHandler\PickUpCartHandler;
...
use Pamil\CartCommand\Infrastructure\Repository\BroadwayCartRepository;
...
final class PickUpCartHandlerTest extends CommandHandlerScenarioTestCase
{
     ...
     * @test
     *
     * @expectedException \Pamil\CartCommand\Application\Exception\CartAlreadyPickedUpException
     */
